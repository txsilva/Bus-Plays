...
<html>
  <head>
	<title>UnB Gama - Ponto de Interesse</title>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
</head>
<body bgcolor="#E0ECF8">
	<center><h3><img src="http://www.busplays.com.br/wp-content/uploads/2020/01/368019-200.png" width="50px">UnB Gama - FCE</h3></center>
	[+] <a href="http://www.busplays.com.br/unb-ceilandia-ponto-de-interesse">Ver mais linhas disponíveis</a>
<?php

$json_file = file_get_contents("unbGama.json");
...
for($i=0;$i<$tamFeatures;$i++){
	if($_GET['linha'] == $json_str['features'][$i][0]["linha"]){
		$linha_file = file_get_contents("unbgama/".$_GET['linha'].".json");
