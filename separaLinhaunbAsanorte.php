...
for($i=0;$i<1246;$i++){
	...
	if(($json_str['features'][$i]["properties"]["codigo_linha"] == 2203) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.110) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 110.2) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.140) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.167) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.168) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.176) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.196) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.338) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.339) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.348) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.349) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.370) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.371) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.392) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.521) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.522) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.769) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.605) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.819) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.851) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 0.853) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 147.9) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 160.2) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 196.2) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 338.1) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 348.1) || ($json_str['features'][$i]["properties"]["codigo_linha"] == 392.2)){
		...
		$arquivo = fopen ("linhas/".$json_str['features'][$i]["properties"]["codigo_linha"].".json", "w+");
		$feature = array(array(
